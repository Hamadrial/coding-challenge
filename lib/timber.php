...
class PixelsSite extends TimberSite {
     ...
     */
		...
		add_image_size('hero-image', 1370, 400, true);
     ...
     */
    register_nav_menus([
        'primary_navigation' => __('Primary Navigation', 'coding-challenge-theme')
		]);
	...
	function add_to_context( $context ) {
		...
		if (is_active_sidebar('footer-contact')) {
			$context['footer_contact'] = Timber::get_widgets('footer-contact');
		}

		if (is_active_sidebar('footer-menu')) {
			$context['footer_menu'] = Timber::get_widgets('footer-menu');
		}
